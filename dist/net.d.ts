...
export declare type NetMessageName =
  | "net_NOP"
  | "net_Disconnect"
  | "net_File"
  | "net_SplitScreenUser"
...
export declare function findByType(
  type: NET_Messages | SVC_Messages
): INetMessageDescriptor;
...
export declare function findUserMessageByName(
  name: UserMessageName
): IUserMessageDescriptor;
export declare function findUserMessageByType(
